...
var faveColors = ['blue', 'orange', 'green']
...
var me = {
    ...
    superPowers: ['flying', 'invisible', 'never aging'],
    superPowerXP: function(){Math.floor(math.random() * 100) + 1},
    profileImage: profileImage = `https://randomuser.me/api/portraits/med/lego/jpg`,
}
...
var regularName = 'Sean';
var superName = 'Super Man';
var homeTown = 'Philadelphia';
